...
class newReleaseExploreScreen extends StatefulWidget {
  const newReleaseExploreScreen({Key? key}) : super(key: key);

  @override
  State<newReleaseExploreScreen> createState() =>
      _newReleaseExploreScreenState();
}

class _newReleaseExploreScreenState extends State<newReleaseExploreScreen> {
                          ...
                          Padding(
                            ...
                            child: Column(
                              children: List.generate(
                                db_data_newRelease_list.length,
                                (index) => Padding(
  ...
  // song card
  Widget songCard(int index, db_data_newRelease db_data_newRelease) {
    return InkWell(
      onTap: () {
        service.get_song_name = db_data_newRelease.data_newRelease!.title;
        Get.to(
          () => songScreen(),
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Align(
                      alignment: Alignment.centerLeft,
                      child: Text(
                        db_data_newRelease.data_newRelease!.description
                            .toString(),
                        style: GoogleFonts.poppins(
                          textStyle: TextStyle(
                            fontSize: FontSize.sub_body_fs,
